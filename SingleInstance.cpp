...
#pragma warning (disable: 6387 4312)
//------------------------------------------------------------------------------
//---------------------------- SHARED DATA CLASS -------------------------------
//------------------------------------------------------------------------------
...
CSingleInstanceData::CSingleInstanceData( LPCTSTR aName ) : mMap( NULL )
// Name:        CSingleInstanceData
// Type:        Constructor
// Description: Create shared memory mapped file or create view of it
{
	...
	// Create file mapping
	// x64 では INVALID_HANDLE_VALUE != (HANDLE)0xFFFFFFFF なのよね
	mMap = CreateFileMapping( INVALID_HANDLE_VALUE,
							  NULL,
							  PAGE_READWRITE,
							  0,
